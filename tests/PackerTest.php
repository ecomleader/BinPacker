...
class PackerTest extends TestCase
{
    ...
    //     $box1 = new TestBox('Le petite box', 'Box', 300, 300, 10, 10, 296, 296, 8, 1000);
    //     $box2 = new TestBox('Le grande box', 'Box', 3000, 3000, 100, 100, 2960, 2960, 80, 10000);
    ...
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box', 'Box', 1, 1, 3, 0, 1, 1, 3, 3));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box', 'Box', 100, 50, 50, 0, 100, 50, 50, 5000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box', 'Box', 370, 375, 60, 140, 364, 374, 40, 3000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box', 'Box', 230, 300, 240, 160, 230, 300, 240, 15000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box A', 'Box', 36, 8, 3, 0, 36, 8, 3, 2));
    //     $packer->addBox(new TestBox('Box B', 'Box', 36, 8, 8, 0, 36, 8, 8, 2));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box1', 'Box', 2, 2, 2, 0, 2, 2, 2, 1000));
    //     $packer->addBox(new TestBox('Box2', 'Box', 4, 4, 4, 0, 4, 4, 4, 1000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Small','Box', 85, 190, 230, 30, 85, 190, 230, 10000));
    //     $packer->addBox(new TestBox('Medium','Box', 220, 160, 160, 50, 220, 160, 160, 10000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Box 1', 'Box', 410, 310, 310, 2000, 410, 310, 310, 60000));
    //     $packer->addBox(new TestBox('Box 2', 'Box', 410, 310, 260, 2000, 410, 310, 260, 60000));
    //     $packer->addBox(new TestBox('Box 3', 'Box', 410, 310, 205, 2000, 410, 310, 205, 60000));
    //     $packer->addBox(new TestBox('Box 4', 'Box', 310, 310, 210, 2000, 310, 310, 210, 60000));
    //     $packer->addBox(new TestBox('Box 5', 'Box', 310, 210, 210, 2000, 310, 210, 210, 60000));
    //     $packer->addBox(new TestBox('Box 6', 'Box', 310, 210, 155, 2000, 310, 210, 155, 60000));
    //     $packer->addBox(new TestBox('Box 7', 'Box', 210, 160, 105, 2000, 210, 160, 105, 60000));
    ...
    // {
    //     $packer = new Packer();
    //     $packer->addBox(new TestBox('Light box', 'Box', 100, 100, 100, 1, 100, 100, 100, 100));
    //     $packer->addBox(new TestBox('Heavy box', 'Box', 100, 100, 100, 100, 100, 100, 100, 10000));
